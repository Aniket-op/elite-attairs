...
const collections = [
  { title: "Traditional Elegance", image: traditionalImg },
  { title: "Classic Western", image: westernImg },
  { title: "Bridal Couture", image: bridalImg },
  { title: "Smart Casuals", image: casualImg },
];
